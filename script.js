...
function editarTarefa(index) {
  ...
  // Altera a ação do botão para "Atualizar" no lugar de "Adicionar"
  const form = document.getElementById('task-form');
  const button = form.querySelector('button');
  button.textContent = 'Atualizar Tarefa';

  // Armazena o índice da tarefa no botão para poder atualizar
  form.onsubmit = function(event) {
    event.preventDefault();

    task.materia = document.getElementById('materia').value;
    task.dia = document.getElementById('dia').value;
    task.hora = document.getElementById('hora').value;
    ...
    // Restaura o formulário para "Adicionar Tarefa"
